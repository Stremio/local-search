`test_app` is a Seed application intended for manual `LocalSearch` testing.

- It's based on [Seed Quickstart](https://github.com/seed-rs/seed-quickstart), see the original quickstart's README below for more info.
